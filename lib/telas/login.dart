...
class _LoginState extends State<Login> {
  ...
  TextEditingController _controllerNome = TextEditingController(text: "Duda Rocha");
  TextEditingController _controllerEmail = TextEditingController(text: "dudarocha@gmail.com");
